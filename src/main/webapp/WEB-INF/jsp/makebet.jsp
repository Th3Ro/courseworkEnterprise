        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/makebet" class="form">
                        <input type="hidden" value="${match.getId()}" name="id">
                        <input type="number" min="10" max="${score}" placeholder="Введите сумму" required name="money">
                        <input type="number" min="1" max="2" placeholder="1" required name="team">
