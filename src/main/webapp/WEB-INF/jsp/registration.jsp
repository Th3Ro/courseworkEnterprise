...
<main class="container">
    ...
    <form class="auth" method="post" action="registration">
        <div class="form-group">
            <label for="inputLogin">Лоин</label>
        ...
        <div class="form-group">
            <label for="inputSurname">Фамиля</label>
        ...
        <button type="submit" class="btn btn-primary in-btn">Зарегистрироваться</button>
        <div>
