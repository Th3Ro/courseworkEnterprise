...
/**
 * Class that summarizes rate data of type {@link net.winnings.model.Bet} и матча типа {@link net.winnings.model.SportMatch}
 * @author Nosolenko
 * @version 1.0
 */
public class BetForUser {
     ...
     * @param money - bit amount
     * @param result - bet result
     */
    public BetForUser(Long matchId, Long betId, String matchName, byte team, Date date, float coef, int money, byte result) {
     ...
     * @param matchName - название матча
     */
